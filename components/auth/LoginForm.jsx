...
/** Deliberately loose: some staff accounts are registered by phone number, not email. */
...
export default function LoginForm() {
  ...
  return (
    <form noValidate action={formAction} onSubmit={check} className="mt-10">
      ...
      {/* Staff only. Agents have their own app, on their own domain, with its
          own sign-in — see lib/agents-app.js — and nothing here points there. */}
