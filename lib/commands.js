...
const SURFACES = [
  ...
  { tab: "coverage", words: ["coverage", "the coverage", "the funnel", "funnel", "who has reported", "reporting rate", "completeness", "how much is in"] },
  ...
  { tab: "alerts", words: ["alert", "alerts", "the alerts", "escalations", "warnings", "what needs attention", "what requires attention", "what is on fire", "what's on fire"] },
  ...
  { tab: "unit", words: ["polling unit", "the polling unit", "unit intelligence", "polling unit intelligence", "booth", "the booth", "this booth"] },
  ...
  { tab: "integrity", words: ["integrity", "verification", "the checks", "anomalies", "the anomalies", "screening", "what looks wrong", "flags", "the flags", "against the declaration", "what was declared here", "declared figures here"] },
  { tab: "sample", words: ["sample", "the sample", "sample design", "sample size", "quick count", "how many booths do we need", "margin of error"] },
  { tab: "quality", words: ["evidence", "the evidence", "data quality", "quality", "what did we capture", "capture"] },
...
const SURFACE_NAME = {
  ...
  unit: "Polling unit intelligence",
  integrity: "Integrity",
