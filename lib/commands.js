...
const SURFACES = [
  ...
  { tab: "alerts", words: ["alert", "alerts", "the alerts", "escalations", "warnings", "what needs attention", "what requires attention", "what is on fire", "what's on fire", "report", "reports", "the reports", "incident", "incidents", "the incidents", "the feed", "situation feed", "report stream"] },
  ...
  { tab: "sample", words: ["sample", "the sample", "sample design", "sample size", "quick count", "how many booths do we need", "margin of error"] },
  ...
  /* ── THE TWO STRATEGIC SURFACES ───────────────────────────────────────
     The brief is asked for by the question rather than the name, every time:
     nobody says "open the strategic brief", they say "where do we stand".
     That is a question about a screen and not one for the assistant to
     answer in prose — the screen answers it with twelve figures and the
     assistant would answer it with one.

     "Strongholds", "battlegrounds" and "opportunities" go to the map rather
     than to the brief, because all three are questions about *where*, and
     the map is the answer with the list beside it. */
  { tab: "executive", words: ["brief", "the brief", "strategic brief", "strategy", "the strategy", "strategic intelligence", "executive", "where do we stand", "how are we doing overall", "our position", "the position", "target", "our target"] },
  { tab: "classify", words: ["geographic intelligence", "classification", "the classification", "classify", "stronghold", "strongholds", "battleground", "battlegrounds", "swing", "swing states", "opportunity", "opportunities", "weak areas", "where are we strong", "where are we weak"] },
  { tab: "planning", words: ["planning", "the plan", "deployment", "planning map", "coverage plan"] },
];

const SURFACE_NAME = {
  pulse: "The overview",
  coverage: "Coverage and booths",
  alerts: "Alerts and field reports",
  timeline: "The timeline",
  operations: "Results operations",
  integrity: "Integrity",
  sample: "The sample design",
  results: "Results",
  register: "Voters",
  turnout: "Turnout",
  density: "Clusters",
  ...
  analytics: "Analytics",
  planning: "Planning",
  executive: "The strategic brief",
  classify: "Geographic intelligence",
};
