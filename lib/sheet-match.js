/* Every party the product can name, not one position's ballot: this compares
   a reading against typed figures without being told which paper either came
   off, and a party missing from the loop is a party whose figures are never
