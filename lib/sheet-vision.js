...
/* The parties with a box of their own on the form this reader is filling in.
   It was the presidential four, taken straight from the 2023 dataset, which
   made the reader structurally incapable of finding a fifth: ADC's row could
   be printed on the sheet in front of it and there was no slot to put the
   figure in. Taken from the ballot now, so the reader looks for exactly what
   the agent is about to be asked to confirm. */
