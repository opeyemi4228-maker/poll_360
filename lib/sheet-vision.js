...
/* ── THE WHOLE READ'S BUDGET, AND ONE ATTEMPT'S SHARE OF IT ───────────────
   ...
   Twelve seconds an attempt is generous for an API that answers a good
   request in two to four, and three attempts inside forty-five leaves the
   backoff room to be worth having. */
const BUDGET_MS = Number(process.env.SHEET_READER_BUDGET_MS ?? 45_000);
