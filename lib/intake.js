...
/**
 * What comes back from Data Bank.
 *
 * ══════════════════════════════════════════════════════════════════════════
 *  THE OTHER HALF OF lib/databank.js
 *
 ...
 *  in — the figures, sheets and situation reports that reached Data Bank from
 ...
 * Data Bank owns the `dumpsite` schema and publishes `intake`. Everything below
 ...
 * A room that wants to look at a sheet opens it through Data Bank, which writes
 ...
 * names the booths Data Bank has heard from and Poll360 has not. Each is
